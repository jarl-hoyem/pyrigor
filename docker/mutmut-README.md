...
- **Behaviour**: Fails CI when surviving mutants exceed the cap in `scripts/check_mutation_score.py`. Timeouts are
  excluded because they track the machine load rather than test quality.
